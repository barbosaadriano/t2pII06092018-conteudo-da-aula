    ...
    public ArrayList<Cliente> listarCliente(Cliente c) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                //Aponta o código para o objeto pegando o nome da consulta
                cli.setNome(rs.getString("nome"));
                //Aponta o código para o objeto pegando o cnpj da consulta
                cli.setCnpj(rs.getString("cnpj"));
                //Aponta o código para o objeto pegando o status da consulta
